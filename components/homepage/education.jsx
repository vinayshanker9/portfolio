...
export default function Education() {
  const seasons = [
    ...
    },
    {
      ...
      overview: "Deep specialization in analytical mathematics, mechanics physics, and fundamental computer science syntax (Python and Java object-oriented principles). Laid a strong foundation for advanced system designs.",
